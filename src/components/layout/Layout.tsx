...
const Layout: React.FC = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50 font-sans">
            <SEO siteTitleOverride={blogConfig.name} />
                        ...
                        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                            <div className="flex flex-col md:flex-row justify-between items-center gap-4 mb-6">
                                <div className="flex gap-6 text-sm text-gray-600">
                                    <Link to="/notice/usage" className="hover:text-indigo-600 font-medium transition-colors">이용약관</Link>
                                    <Link to="/notice/privacy" className="hover:text-indigo-600 font-medium transition-colors">개인정보처리방침</Link>
                                    <Link to="/notice/copyright" className="hover:text-indigo-600 font-medium transition-colors">저작권 정책</Link>
                                    <Link to="/notice/ads" className="hover:text-indigo-600 font-medium transition-colors">광고 및 제휴</Link>
                                </div>
